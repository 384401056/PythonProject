    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('famel', '女')], default='male', max_length=5, verbose_name='性别')),
                ...
                ('image', models.ImageField(default='image/default.png', max_length=200, upload_to='User/images/%Y/%m', verbose_name='用户头像')),
