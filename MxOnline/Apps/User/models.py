...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to=upload_file.upload_to, blank=True, null=True, default="/static/image/default.png", max_length=200, verbose_name="用户头像")
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to=upload_file.upload_to, blank=True, null=True,verbose_name="轮播图片", max_length=100)
